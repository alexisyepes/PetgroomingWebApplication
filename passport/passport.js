...
module.exports = function (passport) {
            ...
            User.findOne({
                ...
                .then(user => {
                    if (!user || !user.password) {
                        return done(null, false, { message: 'No user found under those credentials' });
                    }
    ...
    passport.use('employees-local', new LocalStrategy(
        // Our user will sign in using an email, rather than a "username"
        {
            usernameField: "email"
        },
        ...
        new JWTstrategy(opts, (jwt_payload, done) => {
            try {
                Employee.findOne({
                    ...
                    if (user && user.jobType === "groomer" || user.jobType === "bather") {
