							...
							<div className="row pairs">
								<div className="col-md-3 ">
									...
									<p className="servicesParag">
										...
										your dog’s haircut according to your taste.
									</p>
								</div>
								<div className="col-md-3">
									<img
								...
								<div className="col-md-3">
									...
									<p className="servicesParag">
										Drying and brushing is the most important step in grooming
										your dog. By removing all matted and loose fur before the
										haircut, your dog will come out looking his best.
									</p>
								</div>
								<div className="col-md-3">
									<img
							...
							<div className="row pairs">
								<div className="col-md-3">
									...
									<p className="servicesParag">
										...
										proper products will eliminate most problems. Removing the
										fur by plucking will maintain the ears in a healthy
										condition.
									</p>
								</div>
								<div className="col-md-3">
								...
								<div className="col-md-3">
									<h2>Bathing</h2>
									<p className="servicesParag">
										We bathe your dog with mild shampoos that are safe to use
										with Front-line and Advantage and other spot–on products. We
						...
						<div className="container">
							<div className="row pairs">
								<div className="col-md-3">
									...
									<p className="servicesParag">
										Dogs and Cats need to have their nails trimmed every 4-6
										weeks in order to maintain their quick nice and short.
									</p>
								</div>
								<div className="col-md-3">
									<img
								...
								<div className="col-md-3">
									...
									<p className="servicesParag">
										Tooth Brushing on a regular basis will reduce tartar and
						...
						<div className="container">
							<div className="row pairs">
								<div className="col-md-3">
									...
									<p className="servicesParag">
										Amazing Pet Grooming has packages to suit different needs
										and budgets. From basic Bath and Brush to the ultimate Full
										Service Groom, Amazing Pet Grooming provides options for
										your pet. Take your pets to the professionals, after all…
										they deserve it.
									</p>
								</div>
								<div className="col-md-3">
								...
								<div className="col-md-3">
									...
									<p className="servicesParag">
										De-Tangling services can be provided when coat has been
										maintained properly by brushing it out regularly.
									</p>
								</div>
								<div className="col-md-3">
									<img
